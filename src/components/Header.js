...
//   { name: 'Playlists', href: '/playlist', current: true },
              ...
              <div className="max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 cursor-pointer" onClick={() => navigate('/playlist')}>
                      {/* <img
                        className="h-8 w-8"
                        src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500"
                        alt="Your Company"
                      /> */}
                      <h1 className='text-white font-bold text-3xl'>OFC</h1>
                    </div>
